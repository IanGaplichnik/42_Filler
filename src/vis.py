...
def parse_player_num():
	text_out = pygame.font.Font("press-start/prstart.ttf", 16)
	game_out = pygame.font.Font("press-start/prstart.ttf", 60)
	...
	screen.blit(text_surface, (1200, 630))

	text_surface = text_out.render("Last received piece:", True, 'white')
	screen.blit(text_surface, (1200, 700))
	return (p1, p2)
...
def parse_map(rows, columns):
	...
	p1_old = pygame.Surface(((900 / divider) - 2, (900 / divider) - 2))
	p1_old.fill('cyan4')
	p1_new = pygame.Surface(((900 / divider) - 2, (900 / divider) - 2))
	p1_new.fill('cyan2')
	p2_old = pygame.Surface(((900 / divider) - 2, (900 / divider) - 2))
	p2_old.fill('coral4')
	p2_new = pygame.Surface(((900 / divider) - 2, (900 / divider) - 2))
	p2_new.fill('coral')
	empty = pygame.Surface(((900 / divider) - 2, (900 / divider) - 2))
	empty.fill('gray19')
	text_out = pygame.font.Font("press-start/prstart.ttf", 16)

	clear = pygame.Surface((900, 100))
	clear.fill('black')
	screen.blit(clear, (100,130))
	str = sys.stdin.readline()
	# print(str)
	while (y < int(rows)):
		str = sys.stdin.readline()
	...
	screen.blit(text_surface, (290, 150))
...
def parse_piece(p_rows, p_columns, first_player):
	...
	empty.fill('gray19')
	clear_p1 = pygame.Surface((720, 200))
	clear_p1.fill('black')
	if (first_player % 2 == 1):
		piece = p1_new
		y_coord = 350
...
def pause():
	text_out = pygame.font.Font("press-start/prstart.ttf", 30)
	text_surface = text_out.render("PAUSE", True, 'white')
	empty = pygame.Surface((400, 400))
	empty.fill('black')

	screen.blit(text_surface, (480, 600))
...
def pause_finish(o_score, x_score, p1, p2):
	paused = True
	text_out = pygame.font.Font("press-start/prstart.ttf", 25)
	if o_score > x_score:
	...
	screen.blit(text_surface, (300, 600))
	pygame.display.update()
